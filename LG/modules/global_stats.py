...
from LG import BOT_ID, BOT_NAME, SUDOERS, USERBOT_NAME, app, app2
...
from LG.utils.inlinefuncs import keywords_list
...
@app.on_message(filters.command("lstats") & ~filters.edited & SUDOERS)
@capture_err
async def global_stats(_, message):
    ...
    url = "https://api.github.com/repos/LOGI-TECH/LOGI-BOT/contributors"
    rurl = "https://github.com/LOGI=TECH/LOGI-BOT"
