...
from LG.core.keyboard import ikb
from LG.core.tasks import _get_tasks_text, all_tasks, rm_task
from LG.core.types import InlineQueryResultCachedDocument
from LG.modules.info import get_chat_info, get_user_info
from LG.modules.music import download_youtube_audio
from LG.utils.functions import test_speedtest
...
async def inline_help_func(__HELP__):
    ...
    answerss = [
        ...
        InlineQueryResultArticle(
            ...
            input_message_content=InputTextMessageContent(
                "https://github.com/LOGI-TECH/LOGI-BOT"
            ),
...
async def alive_function(answers):
    ...
    msg = f"""
**[Made By ](https://github.com/LOGI-TECH/LOGI-BOT):**
**MainBot:** `{bot_state}`
**UserBot:** `{ubot_state}`
...
async def music_inline_func(answers, query):
    ...
    group_invite = "https://t.me/joinchat/lgbots"
    try:
        messages = [
            m
